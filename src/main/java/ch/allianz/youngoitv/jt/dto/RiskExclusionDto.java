 ...
 * Positionen still weg, wodurch eine Volatilitaet ueber zwei von fuenf Wertpapieren aussah wie eine
 * ueber das ganze Portfolio.</p>
 *
 * <p>Der Grund ist ein stabiler Code und kein Satz, damit die Oberflaeche ihn uebersetzen kann:
 * {@code NO_PRICE_HISTORY} (der Kursanbieter liefert keine Historie), {@code TOO_FEW_OBSERVATIONS}
 * (zu wenige Handelstage im Zeitraum) oder {@code NO_FX_RATE} (kein Wechselkurs in die Waehrung des
